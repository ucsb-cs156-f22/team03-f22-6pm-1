...
describe("ArticleTable tests", () => {
  ...
  test("Has the expected colum headers and content for adminUser", () => {
    ...
    const expectedFields = ["dateAdded", "email", "explanation", "id", "title", "url"];
  ...
  //     <QueryClientProvider client={queryClient}>
  //       <MemoryRouter>
  //         <ArticleTable dates={articleFixtures.threeDates} currentUser={currentUser} />
  //       </MemoryRouter>
  //     </QueryClientProvider>

  //   );

  //   await waitFor(() => { expect(getByTestId(`ArticleTable-cell-row-0-col-id`)).toHaveTextContent("1"); });
