...
describe("RecommendationTable tests", () => {
  ...
  test("Has the expected colum headers and content for adminUser", () => {
    ...
    const expectedFields = ["requesterEmail", "professorEmail", "explanation", "dateRequested", "dateNeeded", "done"];
  ...
  //   await waitFor(() => { expect(getByTestId(`Recommendation-cell-row-0-col-id`)).toHaveTextContent("1"); });
